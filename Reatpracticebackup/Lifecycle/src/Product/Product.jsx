       ...
       <div className="container mt-5">
         <div className="row">
             ...
             <div className="col-md-5">
                 ...
                 <button className="btn btn-success" Style="margin :40px">Add Cart</button>
                 <button className="btn btn-success" Style="margin :30px">Buy Now</button>
             </div>
             <div className="col-md-5">
                 <table className="table table-hover">
                  <thead className="bg-info">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td><img src={this.state.product1.image} height="200px"/></td>
                 ...
                 <button className="btn btn-success" Style="margin-bottom:40px">Add</button>
             </div>
             <div className="col-md-5">
                 <table className="table table-hover">
                  <thead className="bg-info">
